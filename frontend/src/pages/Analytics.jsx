...
const Analytics = () => {
    ...
    return (
        <DashboardLayout hideHeader={true}>
            <div className="bg-[#F3F7F4] dark:bg-slate-950 min-h-screen -mx-6 px-6 pt-6 pb-20 transition-colors duration-300">
                {/* Custom Header */}
                <div className="flex justify-between items-center mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 leading-tight">Shopping Insights</h1>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Track your pantry budget</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-6 pt-6 space-y-8 max-w-6xl mx-auto">
                    ...
                    <div className="flex justify-center">
                        <div className="bg-[#e8ecea] dark:bg-slate-900 p-2 rounded-2xl flex items-center w-full max-w-lg shadow-sm border dark:border-slate-800">
                        ...
                        <>
                            ...
                            <div className="md:grid md:grid-cols-2 md:gap-10 md:space-y-0 space-y-8">
                                ...
                                <div className="h-full">
                                    {/* Budget Card */}
                                    <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-slate-800 flex flex-col justify-center h-full relative">
                                        <div className="flex justify-between items-start mb-6">
                                            <div className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                                REMAINING BUDGET
                                            </div>
                                            <div className="w-12 h-12 bg-green-50 dark:bg-green-950/40 rounded-xl flex items-center justify-center -mt-2 -mr-2">
                                                <Wallet className="w-6 h-6 text-green-600 dark:text-green-400" />
                                            </div>
                                        </div>

                                        <div className="text-[48px] font-black text-green-500 dark:text-green-400 flex items-center tracking-tight mb-8">
                                            ₹{remaining.toFixed(2)}
                                        </div>

                                        <div className="flex justify-between text-base font-bold text-gray-600 dark:text-gray-400 mb-4">
                                            <span>₹{data.spent.toFixed(2)} spent</span>
                                            <span>Goal: ₹{data.goal.toFixed(2)}</span>
                                        </div>

                                        {/* Progress Bar background */}
                                        <div className="h-5 w-full bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden mb-8">
                                            {/* Progress fill */}
                                            <div
                                ...
                                <div className="h-full">
                                    {/* Categories Card */}
                                    <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-slate-800 h-full flex flex-col justify-between">
                                        <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-8 text-center sm:text-left">Spending Categories</h3>
                                        ...
                                        <div className="flex justify-center items-center mb-10 relative flex-1">
                                            ...
                                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                                <span className="text-4xl font-black text-gray-800 dark:text-gray-100">₹{Math.round(data.spent)}</span>
                                                <span className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-1">TOTAL</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            {data.categories.map(cat => (
                                                <div key={cat.name} className="flex justify-between items-center text-base">
                                                    ...
                                                    <span className="font-black text-gray-800 dark:text-gray-200">₹{cat.amount.toFixed(2)}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 shadow-sm border border-gray-100 dark:border-slate-800 mt-10">
                                <div className="flex items-center gap-3 mb-8">
                                    ...
                                    <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200">Nutritional Intake</h3>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm font-bold">
                                            <span className="text-gray-500 dark:text-gray-400 uppercase tracking-wider">Calories</span>
                                            <span className="text-orange-600 dark:text-orange-400">{Math.round(data.nutrition?.calories || 0)} / 2000 kcal</span>
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm font-bold">
                                            <span className="text-gray-500 dark:text-gray-400 uppercase tracking-wider">Protein</span>
                                            <span className="text-blue-600 dark:text-blue-400">{Math.round(data.nutrition?.protein || 0)} / 50g</span>
                                        </div>
                                        <div className="h-3 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                            <div
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm font-bold">
                                            <span className="text-gray-500 dark:text-gray-400 uppercase tracking-wider">Carbs</span>
                                            <span className="text-purple-600 dark:text-purple-400">{Math.round(data.nutrition?.carbs || 0)} / 250g</span>
                                        </div>
                                        <div className="h-3 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                            <div
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm font-bold">
                                            <span className="text-gray-500 dark:text-gray-400 uppercase tracking-wider">Fat</span>
                                            <span className="text-yellow-600 dark:text-yellow-400">{Math.round(data.nutrition?.fat || 0)} / 70g</span>
                                        </div>
                                        <div className="h-3 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden">
                                            <div
                                ...
                                <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-6 font-medium italic">
